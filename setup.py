...
setup(
    name="electrum-azart-server",
    version="1.0",
    scripts=['run_electrum_azart_server','electrum-azart-server'],
    ...
    description="Azart Electrum Server",
    author="Thomas Voegtlin ,ELM4ever, Propulsion, TheLazieR",
    author_email="thomasv@electrum.org, thelazier@gmail.com",
    license="MIT Licence",
    url="https://github.com/spesmilo/electrum-server/ , https://github.com/thelazier/electrum-azart-server/",
    long_description="""Server for the Electrum Lightweight Azart Wallet"""
)
